package io.betting.application.repository;

import io.betting.application.BettingapplicationApp;
import io.betting.application.config.Constants;
import io.betting.application.config.audit.AuditEventConverter;
import io.betting.application.domain.PersistentAuditEvent;
...
import static io.betting.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
